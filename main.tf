...
# DynamoDB Table for storing simulation data
...
resource "aws_ecr_repository" "lambda_repository" {
  name = "traffic-simulation-lambda-repo"
}
...
# SQS Queues for inter-module communication
...
# Attach policies to allow Lambda access to DynamoDB, SQS, and CloudWatch Logs
...
# Grant API Gateway permission to invoke the stateDump Lambda function
